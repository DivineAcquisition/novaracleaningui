...
const departments = [
  { id: 'all', name: 'View All', icon: Users },
    ...
    <span className="flex items-center gap-1.5">
      <span className="flex gap-0.5">
        {[1, 2, 3, 4].map((i) => (
          <span
            key={i}
            className={`level-dot ${i <= level ? 'active' : 'inactive'}`}
          />
        ))}
      </span>
    ...
    <div className="min-h-screen bg-white text-slate-900 antialiased selection:bg-primary/20 selection:text-primary overflow-x-hidden">
      ...
      <section className="relative z-10 px-6 pt-36 pb-16 md:pt-44 md:pb-20">
        <div className="max-w-3xl mx-auto text-center">
          {/* Badge */}
          <div 
            className={`glow-badge mb-8 ${mounted ? 'animate-fade-in' : 'opacity-0'}`}
          >
            <span className="relative flex h-2 w-2">
          ...
          >
            Join a fast-growing team transforming the home cleaning industry. 
            We're looking for ambitious people ready to deliver exceptional experiences.
          </p>
                    ...
                    {departments.map((dept) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={`text-xs ${isSelected ? 'text-slate-900' : 'text-slate-400'}`}>{count}</span>
                        </button>
                      );
                    })}
                  </div>
                    ...
                    <div className="job-card relative p-6 rounded-2xl bg-white border border-slate-200 overflow-hidden">
                      ...
                      <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-6">
                          ...
                          <ArrowRight className="job-arrow w-5 h-5 text-slate-400 transition-all" />
                        </div>
                      </div>
                    </div>
                  </Link>
      ...
      <section className="relative z-10 py-20 bg-slate-50 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
            ...
            and we'll reach out when something opens up that matches your skills.
          </p>
          <Button 
            size="lg"
