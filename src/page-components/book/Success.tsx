...
import { CheckCircle2, Calendar, Mail, Home, Share2, Download, Clock, MapPin, CreditCard, Settings, UserPlus, ExternalLink, Loader2, AlertCircle } from "lucide-react";
...
export default function BookingSuccess() {
  ...
  const [referralsetReferralLink] = useState<string>('');
