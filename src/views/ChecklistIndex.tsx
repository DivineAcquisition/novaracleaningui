...
import { CHECKLISTS, CHECKLIST_SLUGS } from "@/lib/checklists";
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        description="See exactly what's included in every Novara Cleaning service — Standard, Deep, Move In/Out, and Recurring."
      ...
      <div className="bg-gradient-to-b from-emerald-50/60 via-white to-white dark:from-emerald-950/10 dark:via-background dark:to-background">
        <div className="container max-w-6xl mx-auto px-4 py-12 md:py-16 text-center">
          ...
          <p className="text-base md:text-lg text-muted-foreground mt-3 max-w-2xl mx-auto">
            ...
            mystery, no upsells once we're at your door. Pick a service to see
            the exact line items your cleaner will execute.
          </p>
        </div>
      </div>
      ...
      <div className="container max-w-6xl mx-auto px-4 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {CHECKLIST_SLUGS.map((slug) => {
            ...
            const previewCount = c.sections.reduce(
                ...
                <Card className="h-full border-border/60 hover:border-foreground/20 hover:shadow-lg transition-all">
                  <CardHeader className="pb-3">
                    <div className="flex items-start gap-3">
                      ...
                      >
                        <RiSparklingLine
                          className={cn("w-6 h-6", ACCENT_FG[c.accent])}
                        />
                      </div>
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          <h2 className="text-xl font-bold font-jakarta tracking-tight">
                            {c.name}
                          </h2>
                          <span
                            className={cn(
                      ...
                      <RiArrowRightLine
                        className={cn(
                          "w-5 h-5 mt-2 text-muted-foreground group-hover:text-foreground transition-colors",
                        )}
                      />
                    </div>
                  </CardHeader>
        ...
        <div className="mt-10 text-center">
          <p className="text-sm text-muted-foreground">
            ...
            and we'll guide you to the right one.
          </p>
        </div>
      </div>
