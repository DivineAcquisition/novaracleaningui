    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <Button variant="outline" onClick={() => router.push("/membership")}>View All Plans</Button>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border/50">
        <div className="container max-w-4xl mx-auto px-4 py-3">
          <Button variant="ghost" size="sm" onClick={() => router.push("/membership")} className="-ml-2 text-muted-foreground">
      ...
      <div className="container max-w-4xl mx-auto px-4 py-10 space-y-10">
        ...
        <div className="text-center pb-4">
          <Button variant="ghost" onClick={() => router.push("/membership")} className="text-muted-foreground">
