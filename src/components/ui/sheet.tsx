...
const sheetVariants = cva(
  // Always scroll internally so long side-sheets are fully reachable on mobile.
  "fixed z-50 gap-4 bg-background p-5 sm:p-6 shadow-lg transition ease-in-out overflow-y-auto data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
