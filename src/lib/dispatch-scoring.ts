// Next.js mirror of supabase/functions/_shared/dispatch-scoring.ts
//
// Keep this file in lock-step with the Deno copy. Dispatch, VA-assign, and
// the contractor pulse-check jobs list all score eligibility with one formula.
