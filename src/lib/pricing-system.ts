...
import {
  ...
  PEST_LIGHT_ID as _PEST_LIGHT_ID,
  MOLD_MINOR_ID as _MOLD_MINOR_ID,
  OPS_ONLY_ADD_ON_IDS as _OPS_ONLY_ADD_ON_IDS,
  SCOPE_REASON_ADD_ONS as _SCOPE_REASON_ADD_ONS,
...
export const PEST_LIGHT_ID = _PEST_LIGHT_ID;
export const MOLD_MINOR_ID = _MOLD_MINOR_ID;
export const OPS_ONLY_ADD_ON_IDS = _OPS_ONLY_ADD_ON_IDS;
export const SCOPE_REASON_ADD_ONS = _SCOPE_REASON_ADD_ONS;
