...
// ─── Home Size Ranges (Zone B base prices — v3.4) ───────────────────────
// v3.4 = v3.3 lowered 10% across the board (Membership pricing stays at
// the listed rate card — only one-time / combo prices come down).
// All standard base prices are still EVEN dollars so post-50%-off totals
// stay clean (no rounding drift between offer card and checkout summary).
export const HOME_SIZE_RANGES: HomeSizeRange[] = [
  { id: '0_999',      label: '0 – 999 sq ft',       minSqft: 0,    maxSqft: 999,   bedroomRange: 'Studio – 1 BR',         baseHours: 2.0, standardPrice: 270,   cleaners: '1' },
  { id: '1000_1500',  label: '1,000 – 1,500 sq ft',  minSqft: 1000, maxSqft: 1500,  bedroomRange: '1–2 BR condos/homes',   baseHours: 2.5, standardPrice: 342,   cleaners: '1' },
  { id: '1501_2000',  label: '1,501 – 2,000 sq ft',  minSqft: 1501, maxSqft: 2000,  bedroomRange: '2–3 BR apartments',     baseHours: 3.0, standardPrice: 432,   cleaners: '1' },
  { id: '2001_2500',  label: '2,001 – 2,500 sq ft',  minSqft: 2001, maxSqft: 2500,  bedroomRange: '3–4 BR homes',          baseHours: 3.5, standardPrice: 504,   cleaners: '1' },
  { id: '2501_3000',  label: '2,501 – 3,000 sq ft',  minSqft: 2501, maxSqft: 3000,  bedroomRange: '4 BR homes',            baseHours: 4.0, standardPrice: 612,   cleaners: '1-2' },
  { id: '3001_3500',  label: '3,001 – 3,500 sq ft',  minSqft: 3001, maxSqft: 3500,  bedroomRange: '4–5 BR homes',          baseHours: 4.5, standardPrice: 684,   cleaners: '1-2' },
  { id: '3501_4000',  label: '3,501 – 4,000 sq ft',  minSqft: 3501, maxSqft: 4000,  bedroomRange: '5 BR homes',            baseHours: 5.0, standardPrice: 792,   cleaners: '2' },
  { id: '4001_4500',  label: '4,001 – 4,500 sq ft',  minSqft: 4001, maxSqft: 4500,  bedroomRange: '5+ BR homes',           baseHours: 5.5, standardPrice: 882,   cleaners: '2' },
  { id: '4501_5000',  label: '4,501 – 5,000 sq ft',  minSqft: 4501, maxSqft: 5000,  bedroomRange: '5+ BR large homes',     baseHours: 6.0, standardPrice: 972,   cleaners: '2' },
