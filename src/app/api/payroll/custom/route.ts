...
// ─── mark_paid: flip a pending payout to paid (status + Airtable sync) ──────
// Bookkeeping only — records the payout as paid and re-syncs the Jobs row to
// Airtable. (No Stripe transfer here; contractor payouts are released through
// the Stripe-Connect payroll flows.)
