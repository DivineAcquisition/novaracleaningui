...
const API_ROUTES_STATIC: Record<string, unknown> = {
  ...
  "/api/admin/pnl": (() => {
    const today = demo.DEMO_DATES.iso(0);
    ...
    const prevDate = new Date(`${month}-01T12:00:00Z`);
    prevDate.setUTCMonth(prevDate.getUTCMonth() - 1);
    const prev = prevDate.toISOString().slice(0, 7);
    const prevLabel = new Date(`${prev}-01T12:00:00Z`).toLocaleDateString("en-US", {
      month: "long",
      year: "numeric",
      timeZone: "UTC",
    });
    return {
      ...
      todayYmd: today,
      since: "2026-05-01",
      sheetUrl: "https://docs.google.com/spreadsheets/d/demo-pl-sheet",
      selectedMonth: month,
      months: [
        {
          month: prev,
          label: prevLabel,
          collectedCents: 218800,
          pipelineCents: 0,
          cleanerPayCents: 87520,
          extraPayCents: 4500,
          jobProfitCents: 126780,
          adSpendCents: 0,
          paidExpenseCents: 0,
          promisedExpenseCents: 0,
          contributionCents: 126780,
          collectedRoas: null,
          bookedRoas: null,
          completedJobs: 11,
          pipelineJobs: 0,
        },
        {
          month,
          label,
          collectedCents: 66150,
          pipelineCents: 170952,
          cleanerPayCents: 23814,
          extraPayCents: 0,
          jobProfitCents: 42336,
          adSpendCents: 49500,
          paidExpenseCents: 0,
          promisedExpenseCents: 4000,
          contributionCents: -7164,
          collectedRoas: 1.34,
          bookedRoas: 4.79,
          completedJobs: 2,
          pipelineJobs: 4,
      ...
      jobs: [
        {
          ...
          ref: "NVC-10238",
          client: "Marcus Webb",
          serviceDate: demo.DEMO_DATES.iso(-2),
          serviceType: "moveInOut",
          status: "completed",
          revenueCents: 42525,
          cleanerPayCents: 15309,
          extraPayCents: 0,
          profitCents: 27216,
          pipeline: false,
          reclean: false,
        },
        {
          ...
          ref: "NVC-10244",
          client: "Hannah Delacroix",
          serviceDate: today,
          serviceType: "standard",
          status: "completed",
          revenueCents: 23625,
          cleanerPayCents: 8505,
          extraPayCents: 0,
          profitCents: 15120,
          pipeline: false,
          reclean: false,
        ...
        },
        {
          ...
          ref: "NVC-10242",
          client: "Priya Anand",
          serviceDate: demo.DEMO_DATES.iso(1),
          serviceType: "deep",
          status: "assigned",
          revenueCents: 83096,
          cleanerPayCents: 0,
      ...
      ads: [
        {
          ...
          leads_calls: 11,
          booked_jobs: 2,
          campaign_notes: "September lead ads",
          month,
          collectedRoas: 1.34,
          bookedRoas: 4.79,
        },
