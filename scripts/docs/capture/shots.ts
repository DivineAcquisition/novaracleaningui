...
export const SHOTS: Shot[] = [
  ...
  // ── Commercial ───────────────────────────────────────────────────────────
  {
    id: "commercial-hub",
    doc: "commercial",
    caption: "Accounts — management for clients, STR, portfolios, and certificates.",
    url: "/admin/accounts",
    waitForText: "Accounts",
    callouts: [
      { text: "Accounts", nth: 0, label: "Business accounts" },
      { text: "Jobs", nth: 0, label: "Commercial jobs" },
      { text: "Compliance", nth: 0, label: "Certificates of insurance" },
      { text: "STR", nth: 0, label: "Host management" },
      { text: "Portfolio", nth: 0, label: "Property managers" },
    ],
    fullPage: true,
  },
