...
export const SHOTS: Shot[] = [
  ...
  // ── Commercial ───────────────────────────────────────────────────────────
  {
    id: "commercial-hub",
    doc: "commercial",
    caption: "Accounts — one list for clients, STR, and portfolios; certificates and STR ops sit on this tab.",
    url: "/admin/accounts",
    waitForText: "Accounts",
    callouts: [
      { text: "Accounts", nth: 0, label: "Every relationship" },
      { text: "Jobs", nth: 0, label: "Commercial jobs + book a site" },
      { text: "Recurring", nth: 0, label: "Partner schedules" },
      { text: "Certificates", nth: 0, label: "Certificates of insurance" },
      { text: "STR ops", nth: 0, label: "Turnover queue" },
    ],
    fullPage: true,
  },
